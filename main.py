...
st.image('https://avatars.mds.yandex.net/i?id=158d4ddefbcb6b7b16a2354feb1bd061-4971670-images-thumbs&n=13', width=50)
st.markdown("Вы проделали долгий путь, приехали в ресторан, но вам там не понравилось. Очент грустно((( Что же делать?")
st.image('https://avatars.mds.yandex.net/i?id=20ccdf5b3f2bb81bdd399e208e520ac4-5460273-images-thumbs&n=13', width=50)
