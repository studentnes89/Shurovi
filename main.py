...
pizza_df['diameter'] = pizza_df['diameter'].replace('8.5', "8")
pizza_df['diameter'] = pizza_df['diameter'].replace('18.5', "18")
pizza_df['diameter'] = pizza_df['diameter'].replace('16.5', "16")
pizza_df = pizza_df.astype({"diameter": "float.64"})
