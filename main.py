...
with st.echo(code_location='below'):
        ...
        st.pyplot(figure)
        st.markdown("Вершины 0-4 обозначают категории цен, а вершины 5-7 обозначают добавки, заметим, что на графе каждая вершины из категории добавок связяна с каждой вершиной из категории цен.")
